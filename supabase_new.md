# Saksha Full Database Setup — Copy/Paste into Supabase SQL Editor

Go to: **Supabase Dashboard → SQL Editor → New Query**

Paste the entire SQL block below and click **Run**.
...
-- NOTIFICATIONS (12 inter-station messages)
...
('dd000000-0000-0000-0000-000000000004', NULL, 'b0000000-0000-0000-0000-000000000001', 'Scheduled System Maintenance Notice', 'system_notification', 'system_notification', 'System Maintenance — 23:30 to 00:30', 'Platform maintenance is scheduled tonight between 23:30 and 00:30 IST.', 'low', 'low', 'read', NULL, NULL, TRUE, TRUE, now() - interval '12 hours'),
...
('dd000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'AI Hotspot Prediction Generated — 3 Emerging Zones', 'intelligence_sharing', 'intelligence_sharing', 'Hotspot Predictions Ready for Review', 'AI model has identified three emerging crime hotspots in Bengaluru Urban requiring review.', 'medium', 'medium', 'acknowledged', NULL, NULL, FALSE, FALSE, now() - interval '6 hours'),
...
1. Create a **new Supabase project** (if using a different one)
2. Go to **SQL Editor → New Query**
3. Paste the entire SQL block above
4. Click **Run**
5. Update `backend/.env` with your new connection credentials:
   - `DATABASE_URL` (Transaction mode, port 6543)
   - `DATABASE_URL_DIRECT` (Session mode, port 5432)
6. Run `npm run dev:all` to start the app
...
| `IO-3921` | `456789` | investigator |
| `SP-0088` | `987654` | inspector |
