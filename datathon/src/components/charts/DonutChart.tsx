...
const DEFAULT_CRIME_CATEGORIES: PieDataPoint[] = [
...
export const DonutChart: React.FC<DonutChartProps> = ({ data }) => {
  const chartData = data && data.length ? data : DEFAULT_CRIME_CATEGORIES;
  const totalCrimes = chartData.reduce((a, b) => a + b.value, 0);
