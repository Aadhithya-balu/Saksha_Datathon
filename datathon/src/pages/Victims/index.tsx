      ...
      <div className="flex-grow w-full grid grid-cols-1 lg:grid-cols-12 gap-5 overflow-hidden">
        ...
        <div className="lg:col-span-4 bg-[#111D35]/30 border border-border-color p-4 rounded-card flex flex-col gap-4 overflow-hidden">
          <div className="flex justify-between items-center border-b border-slate-900 pb-2 shrink-0">
            <span className="text-[10px] font-mono font-bold text-[#E8EDF5] uppercase tracking-wider">Victims Registry</span>
            <div className="w-44 flex items-center relative text-xs">
              <input
                ...
                className="w-full pl-7 pr-3 py-1 bg-slate-950/70 border border-border-color rounded text-white outline-none focus:border-[#0E9E78] font-mono text-[10px]"
              />
        ...
        <div className="lg:col-span-8 bg-slate-950 border border-border-color p-5 rounded-card flex flex-col gap-5 overflow-y-auto custom-scrollbar">
          ...
          {loadingDetails ? (
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-slate-900/40 border border-slate-900 rounded flex flex-col md:flex-row gap-4 items-center md:items-start select-none">
                ...
                <div className="flex-1 w-full text-center md:text-left font-mono">
                  <div className="flex flex-col md:flex-row md:justify-between items-center md:items-start gap-2">
                    <div>
                      <h3 className="text-sm font-extrabold text-white uppercase tracking-wider">{victimDetails.full_name}</h3>
                      <span className="text-[9.5px] text-[#A8B4CC] block mt-1 uppercase">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 mt-4 text-[9.5px]">
                    <div className="p-2 bg-slate-950/60 border border-slate-900 rounded">
                      <span className="text-slate-500 uppercase text-[7.5px] block">Age</span>
                      <span className="text-white block mt-0.5">{victimDetails.age || 'UNKNOWN'}</span>
                    </div>
                    <div className="p-2 bg-slate-950/60 border border-slate-900 rounded">
                      <span className="text-slate-500 uppercase text-[7.5px] block">Gender</span>
                      <span className="text-white block mt-0.5 uppercase">{victimDetails.gender || 'UNKNOWN'}</span>
                    </div>
                    <div className="p-2 bg-slate-950/60 border border-slate-900 rounded col-span-2">
                      <span className="text-slate-500 uppercase text-[7.5px] block">Contact Number</span>
              ...
              {/* Address card */}
              <div className="p-3.5 bg-slate-950 border border-slate-900 rounded flex flex-col gap-1.5 text-left font-mono text-xs">
              ...
              <div className="p-4 bg-slate-950 border border-slate-900 rounded text-left font-mono">
                <span className="text-[#0E9E78] uppercase font-bold text-[8.5px] tracking-wider flex items-center gap-1.5 border-b border-slate-900 pb-2">
                  <FileText className="w-3.5 h-3.5" /> Official Victim / Witness Statement
                </span>
                <p className="text-[#A8B4CC] leading-relaxed text-[10.5px] bg-slate-900/15 p-3 border border-slate-900/50 rounded mt-3 whitespace-pre-line italic">
              ...
              <div className="p-4 bg-slate-950 border border-slate-900 rounded text-left">
                <span className="text-[#0E9E78] font-mono font-bold text-[8.5px] tracking-wider uppercase block border-b border-slate-900 pb-2">
                ...
                <div className="mt-3 overflow-x-auto font-mono">
                  {victimDetails.firs?.length > 0 ? (
                    <table className="w-full text-[9px] text-[#A8B4CC]">
                      <thead>
